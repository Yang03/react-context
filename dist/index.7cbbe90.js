...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/recoil/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
module.exports = __webpack_require__(/*! core-js/library/fn/get-iterator */ "./node_modules/@babel/runtime/node_modules/core-js/library/fn/get-iterator.js");
...
var _getIterator = __webpack_require__(/*! ../core-js/get-iterator */ "./node_modules/@babel/runtime/core-js/get-iterator.js");
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js?!./src/recoil/index.scss":
/*!*****************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src??ref--5-2!./src/recoil/index.scss ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/recoil/dist/recoil.js":
/*!********************************************!*\
  !*** ./node_modules/recoil/dist/recoil.js ***!
  \********************************************/
/*! no static exports found */
...
var t = e(__webpack_require__(/*! react */ "./node_modules/react/index.js")),
    n = e(__webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js"));
var o = {
...
var r = function (e) {
  var t, n;
  const o = null !== (n = (null != e ? null !== (t = e.ownerDocument) && void 0 !== t ? t : e : document).defaultView) && void 0 !== n ? n : window;
  return !(null == e || !("function" == typeof o.Node ? e instanceof o.Node : "object" == typeof e && "number" == typeof e.nodeType && "string" == typeof e.nodeName));
};
...
var s = function e(t) {
  if ("object" == typeof t && !function (e) {
    ...
    return null != e["@@__IMMUTABLE_ITERABLE__@@"] || null != e["@@__IMMUTABLE_KEYED__@@"] || null != e["@@__IMMUTABLE_INDEXED__@@"] || null != e["@@__IMMUTABLE_ORDERED__@@"] || null != e["@@__IMMUTABLE_RECORD__@@"] || !!r(e) || !!a(e);
  }(t)) {
    Object.freeze(t);

    for (const n in t) t.hasOwnProperty(n) && e(t[n]);
...
const i = {
  ...
  map(e) {
    ...
    if ("hasValue" === this.state) try {
      ...
      return a(t) ? d(t.next(() => e(this.contents))) : l(t);
    }
    if ("loading" === this.state) return d(this.contents.then(e).catch(t => {
...
var f = {
  ...
  loadableAll: function (e) {
    return e.every(e => "hasValue" === e.state) ? c(e.map(e => e.contents)) : e.some(e => "hasError" === e.state) ? l(u(e.find(e => "hasError" === e.state), "Invalid loadable passed to loadableAll").contents) : d(Promise.all(e.map(e => e.contents)));
  }
};
...
class p {
  constructor(e) {
    var t, n, o;
    o = void 0, (n = "key") in (t = this) ? Object.defineProperty(t, n, {
      value: o,
      enumerable: !0,
      configurable: !0,
      writable: !0
...
var S = {
  ...
  RecoilState: class extends p {},
  RecoilValueReadOnly: class extends p {}
},
    b = S.AbstractRecoilValue,
    h = S.RecoilState,
    m = S.RecoilValueReadOnly,
    R = Object.freeze({
  __proto__: null,
...
var T = {
  ...
  registerNode: function (e) {
    ...
    return w.set(e.key, e), null == e.set ? new R.RecoilValueReadOnly(e.key) : new R.RecoilState(e.key);
  },
  getNode: function (e) {
    const t = w.get(e);
    if (null == t) throw new V(`Missing definition for RecoilValue: "${e}""`);
    return t;
  },
  NodeMissingError: V,
  DefaultValue: v,
  DEFAULT_VALUE: y,
  RecoilValueNotReady: g
};
var A = {
...
const {
  ...
  mapBySettingInMap: M,
  mapByUpdatingInMap: N,
  setByAddingToSet: _
} = o,
      {
  getNode: L
} = T,
      k = Object.freeze(new Map()),
      B = Object.freeze(new Set());
...
var O = {
  ...
  setNodeValue: function (e, t, n, o) {
    const r = L(n);
    if (null == r.set) throw new U("Attempt to set read-only RecoilValue: " + n);
  ...
  setUnvalidatedAtomValue: function (e, t, n) {
    return { ...e,
      ...
      nonvalidatedAtoms: M(e.nonvalidatedAtoms, t, n),
      dirtyAtoms: _(e.dirtyAtoms, t)
    };
  },
  subscribeComponentToNode: function (e, t, n) {
    const o = C++;
    return [{ ...e,
      nodeToComponentSubscriptions: N(e.nodeToComponentSubscriptions, t, e => M(null != e ? e : k, o, ["TODO debug name", n]))
    }, function (e) {
      return { ...e,
        nodeToComponentSubscriptions: N(e.nodeToComponentSubscriptions, t, e => E(null != e ? e : k, o))
      };
    }];
  },
  fireNodeSubscriptions: function (e, t, n) {
    ...
    const r = "enqueue" === n && null !== (o = e.getState().nextTree) && void 0 !== o ? o : e.getState().currentTree,
          a = function (e, t) {
      const n = new Set(),
            o = new Set(),
            r = Array.from(t);

      for (let t = r.pop(); t; t = r.pop()) {
        var a;
        n.add(t), o.add(t);
        const s = null !== (a = e.nodeToNodeSubscriptions.get(t)) && void 0 !== a ? a : B;

        for (const e of s) o.has(e) || r.push(e);
      }
    ...
    for (const t of a) {
      var s;
      (null !== (s = r.nodeToComponentSubscriptions.get(t)) && void 0 !== s ? s : []).forEach(([t, o]) => {
        "enqueue" === n ? e.getState().queuedComponentCallbacks.push(o) : o(r);
      });
    }

    A.trace("value became available, waking components", Array.from(t).join(", "), () => {
  ...
  detectCircularDependencies: function e(t, n) {
    ...
    const a = n[0];
    if (r.has(a)) throw new Error("Recoil selector has circular dependencies: " + [...n, a].reverse().join(" → "));

    for (const o of r) e(t, [...n, o]);
  }
};
const {
  getNodeLoadable: D,
  peekNodeLoadable: I,
  setNodeValue: j,
  setUnvalidatedAtomValue: P,
  subscribeComponentToNode: z
} = O,
      {
  RecoilValue: q,
...
var G = {
  AbstractRecoilValue: F,
  RecoilState: $,
  peekRecoilValueAsLoadable: function (e, {
    key: t
  }) {
    const n = e.getState().currentTree;
    return I(e, n, t);
  },
  getRecoilValueAsLoadable: function (e, {
    ...
    let n;
    return A.trace("get RecoilValue", t, () => e.replaceState(A.wrap(o => {
      const [r, a] = D(e, o, t);
      return n = a, r;
    }))), n;
  },
  setRecoilValue: function (e, {
    ...
    A.trace("set RecoilValue", t, () => e.replaceState(A.wrap(o => {
      const [r, a] = j(e, o, t, n);
  ...
  setUnvalidatedRecoilValue: function (e, {
    ...
    A.trace("set unvalidated persisted atom", t, () => e.replaceState(A.wrap(o => {
      const r = P(o, t, n);
  ...
  subscribeToRecoilValue: function (e, {
    ...
    let o, r;
    return A.trace("subscribe component to RecoilValue", t, () => e.replaceState(A.wrap(e => ([o, r] = z(e, t, n), o)))), {
      release: e => e.replaceState(r)
    };
  },
  isRecoilValue: function (e) {
    return e instanceof $ || e instanceof W;
  }
};
const {
  mapByDeletingFromMap: K,
  mapBySettingInMap: X,
  setByAddingToSet: Y
} = o,
      {
...
function te(e) {
  ...
  return ee(t) || a(t) ? function (e) {
    const t = te({ ...e,
      default: J,
      persistence_UNSTABLE: void 0 === e.persistence_UNSTABLE ? void 0 : { ...e.persistence_UNSTABLE,
        validator: t => t instanceof Q ? t : u(e.persistence_UNSTABLE).validator(t, J)
      }
    });
    return selector({
      ...
      get: ({
        ...
        const o = n(t);
        return o instanceof Q ? e.default : o;
      },
      set: ({
        set: e
      }, n) => e(t, n),
    ...
    return Z({
      ...
      options: e,
      get: (o, r) => {
        if (r.atomValues.has(t)) return [r, u(r.atomValues.get(t))];

        if (r.nonvalidatedAtoms.has(t)) {
          if (null == n) return [r, H(e.default)];
          const o = r.nonvalidatedAtoms.get(t),
                a = n.validator(o, J);
          return a instanceof Q ? [{ ...r,
            nonvalidatedAtoms: K(r.nonvalidatedAtoms, t)
          }, H(e.default)] : [{ ...r,
            atomValues: X(r.atomValues, t, H(a)),
            nonvalidatedAtoms: K(r.nonvalidatedAtoms, t)
          }, H(a)];
        }

        return [r, H(e.default)];
      },
      set: (n, o, r) => (!0 !== e.dangerouslyAllowMutability && s(r), [{ ...o,
        dirtyAtoms: Y(o.dirtyAtoms, t),
        atomValues: r instanceof Q ? K(o.atomValues, t) : X(o.atomValues, t, H(r)),
        nonvalidatedAtoms: K(o.nonvalidatedAtoms, t)
      }, new Set([t])])
    });
  }({ ...n,
    default: t
...
const {
  ...
  useState: ue
      ...
      {
  fireNodeSubscriptions: ie,
  setNodeValue: ce,
  setUnvalidatedAtomValue: le
} = O;
...
const fe = Object.freeze({
  getState: de,
  replaceState: de,
  subscribeToTransactions: de,
  addTransactionMetadata: de,
  fireNodeSubscriptions: de
});

function pe(e) {
  null === e.nextTree && (e.nextTree = { ...e.currentTree,
    dirtyAtoms: new Set(),
    transactionMetadata: {}
  });
}
...
function he(e) {
  const t = be(),
        [n, o] = ue([]);
  return e.setNotifyBatcherOfChange(() => o({})), ae(() => {
    oe.enqueueExecution("Batcher", () => {
      const e = t.current.getState(),
            {
        currentTree: n,
        nextTree: o
      } = e;
      null !== o && (o.dirtyAtoms.size && e.transactionSubscriptions.forEach(e => e(t.current, n)), e.queuedComponentCallbacks.forEach(e => e(o)), e.queuedComponentCallbacks.splice(0, e.queuedComponentCallbacks.length), e.currentTree = o, e.nextTree = null);
    });
  }), null;
}
...
function me(e, t) {
  ...
  return t && t({
    set: (t, o) => {
      n.currentTree = ce(e, n.currentTree, t.key, o)[0];
    },
    setUnvalidatedAtomValues: e => {
      e.forEach((e, t) => {
        n.currentTree = le(n.currentTree, t, e);
      });
    }
  }), n;
}
...
var ve = {
  ...
  RecoilRoot: function ({
    ...
    const r = se(null),
      ...
      getState: () => o.current,
      replaceState: e => {
        const t = s.current.getState();
        pe(t);
        const n = u(t.nextTree),
              o = e(n);
        o !== n && (t.nextTree = o, u(r.current)());
      },
      subscribeToTransactions: e => {
        const t = Re++;
        return s.current.getState().transactionSubscriptions.set(t, e), {
          release: () => {
            s.current.getState().transactionSubscriptions.delete(t);
          }
        };
      },
      addTransactionMetadata: e => {
        pe(s.current.getState());

        for (const t of Object.keys(e)) u(s.current.getState().nextTree).transactionMetadata[t] = e[t];
      },
      fireNodeSubscriptions: function (e, t) {
        ie(s.current, e, t);
          ...
          s = se(a);
    return o = se(me(a, e)), t.createElement(Se.Provider, {
      value: s
    }, t.createElement(he, {
...
const {
  ...
  getRecoilValueAsLoadable: ze,
  setRecoilValue: qe,
  setUnvalidatedRecoilValue: Fe,
  subscribeToRecoilValue: We
} = G;
...
function $e(e, t) {
  return {
    ...
    nodeToNodeSubscriptions: Te(e.nodeToNodeSubscriptions, e => new Set(e)),
    nodeToComponentSubscriptions: Te(e.nodeToComponentSubscriptions, e => new Map(e))
  };
}

function Ge(e, t, n, o) {
  if ("function" == typeof o) {
    const r = Ue(e, t, n.key);
    if ("loading" === r.state) throw new Oe(n.key);
    if ("hasError" === r.state) throw r.contents;
    return o(r.contents);
  }
...
function Ke() {
  ...
  return Me(() => {
    ...
    ye(o.current, r.current).forEach(e => {
      if (a.current.has(e)) return;
      const n = We(t, new Pe(e), t => {
        A.trace("RecoilValue subscription fired", e, () => {
          u(0, e);
        });
      });
      a.current.set(e, n), A.trace("initial update on subscribing", e, () => {
        u(t.getState(), e);
      });
    }), ye(r.current, o.current).forEach(e => {
      s(e);
    }), r.current = o.current;
  }), Me(() => {
    const e = a.current;
    ...
    function t(t) {
      return n => {
        ...
        const r = e.current.getState(),
              a = Ge(e.current, null !== (o = r.nextTree) && void 0 !== o ? o : r.currentTree, t, n);
        qe(e.current, t, a);
      };
    }

    function n(t) {
      return o.current.has(t.key) || (o.current = ke(o.current, t.key)), ze(e.current, t);
    }
...
function Xe(e) {
  const t = je();
  Me(() => t.current.subscribeToTransactions(e).release, [e, t]);
}
...
function Ye(e) {
  const t = e.atomValues,
        n = Te(ge(t, (e, t) => {
    var n;
    const o = null === (n = De(t).options) || void 0 === n ? void 0 : n.persistence_UNSTABLE;
    return null != o && "none" !== o.type && "hasValue" === e.state;
  }), e => e.contents);
  return Ae(e.nonvalidatedAtoms, n);
}
...
var Qe = {
  useRecoilCallback: function (e, t) {
    const o = je();
    return Ee((...t) => {
      let r = $e(o.current.getState().currentTree, {
        isSnapshot: !0
      });

      function a(e) {
        let t;
        return [r, t] = Be(o.current, r, e.key), t;
      }
      ...
      }), Ve(!(c instanceof He), "unstable_batchedUpdates should return immediately"), c;
    }, null != t ? [...t, o] : void 0);
  },
  useRecoilValue: function (e) {
    return Ke().getRecoilValue(e);
  },
  useRecoilValueLoadable: function (e) {
    return Ke().getRecoilValueLoadable(e);
  },
  useRecoilState: function (e) {
    const t = Ke(),
          [n] = t.getRecoilState(e);
    return [n, Ee(t.getSetRecoilState(e), [e])];
  },
  ...
  useSetRecoilState: function (e) {
    return Ee(Ke().getSetRecoilState(e), [e]);
  },
  useResetRecoilState: function (e) {
    return Ee(Ke().getResetRecoilState(e), [e]);
  },
  useRecoilInterface: Ke,
  useTransactionSubscription: Xe,
  useSnapshotWithStateChange: function (e) {
    const t = je();

    let n = function () {
      const [e, t] = Le(0);
      return Xe(Ee(() => t(e => e + 1), [])), $e(je().current.getState().currentTree, {
        isSnapshot: !0
      });
    }();
    ...
    e(({
      ...
      [n] = xe(t.current, n, e, Ue(t.current, n, e).map(o));
    });
    const o = Te(n.atomValues, e => e.contents),
          r = we(n.dirtyAtoms, new Set(o.keys()));
    return {
      atomValues: o,
      updatedAtoms: r
    };
  },
  useTransactionObservation: function (e) {
    Xe(Ee((t, n) => {
      ...
      const r = Ye(o),
        ...
        return {
          persistence_UNSTABLE: {
            type: null !== (t = null === (n = e.options) || void 0 === n || null === (o = n.persistence_UNSTABLE) || void 0 === o ? void 0 : o.type) && void 0 !== t ? t : "none",
            backButton: null !== (r = null === (a = e.options) || void 0 === a || null === (s = a.persistence_UNSTABLE) || void 0 === s ? void 0 : s.backButton) && void 0 !== r && r
          }
        };
      }),
            u = new Set(o.dirtyAtoms);
      e({
        atomValues: r,
  ...
  useGoToSnapshot: function () {
    const e = je();
    return t => {
      n.unstable_batchedUpdates(() => {
        t.updatedAtoms.forEach(n => {
          qe(e.current, new Pe(n), t.atomValues.get(n));
        });
      });
    };
  },
  useSetUnvalidatedAtomValues: function () {
    ...
    return (t, o = {}) => {
      n.unstable_batchedUpdates(() => {
        e.current.addTransactionMetadata(o), t.forEach((t, n) => Fe(e.current, new Pe(n), t));
      });
    };
  }
};
const Ze = Symbol("ArrayKeyedMap"),
      et = new Map();

class tt {
  constructor(e) {
    if (this._base = new Map(), e instanceof tt) for (const [t, n] of e.entries()) this.set(t, n);else if (e) for (const [t, n] of e) this.set(t, n);
    return this;
  }
  ...
  get(e) {
    ...
    return t.forEach(e => {
      var t;
      n = null !== (t = n.get(e)) && void 0 !== t ? t : et;
    }), void 0 === n ? void 0 : n.get(Ze);
  }
  ...
  entries() {
    ...
    return function t(n, o) {
      n.forEach((n, r) => {
        r === Ze ? e.push([o, n]) : t(n, o.concat(r));
      });
    }(this._base, []), e.values();
  }
...
var st = function (e, t) {
  return e.size === t.size && at(e, e => t.has(e));
};

Object.freeze(new Set());
const {
  mapBySettingInMap: ut,
  mapByUpdatingInMap: it,
  setByAddingToSet: ct,
  setByDeletingFromSet: lt
} = o,
      {
  detectCircularDependencies: dt,
  getNodeLoadable: ft,
  setNodeValue: pt
} = O,
      {
  loadableWithError: St,
  loadableWithPromise: bt,
  loadableWithValue: ht
} = f,
      {
  DEFAULT_VALUE: mt,
  RecoilValueNotReady: Rt,
  registerNode: vt
} = T,
      {
  startPerfBlock: yt
...
var Tt = function (e) {
  const {
    key: t,
    get: n,
    cacheImplementation_UNSTABLE: o
  } = e,
  ...
  function i(o, r) {
    var c;
    let l = r;
    const d = null !== (c = r.nodeDeps.get(t)) && void 0 !== c ? c : wt,
          f = Vt(new Map(Array.from(d).sort().map(e => {
      const [t, n] = ft(o, l, e);
      return l = t, [e, n];
    }))),
          p = u.get(f);
    ...
    const [S, b, h] = function (e, o) {
      var r;

      const [s, u, c] = function (e, o) {
        const r = yt(t);
        let s = o;
        const u = new Map();
        ...
        function c({
          ...
          let n;
          if ([s, n] = ft(e, o, t), u.set(t, n), "hasValue" === n.state) return n.contents;
          throw n.contents;
        }
        ...
        try {
          const e = n({
            get: c
                ...
                t = gt(e) ? c(e) : e,
                o = a(t) ? bt(t.finally(r)) : (r(), ht(t));
          return [s, o, u];
        } catch (t) {
          const n = a(t) ? bt(t.then(() => {
            let t = St(new Error("Internal Recoil Selector Error"));
            if (e.replaceState(n => {
              let o;
              return [o, t] = i(e, n), o;
      ...
      let l = s;
      const d = null !== (r = o.nodeDeps.get(t)) && void 0 !== r ? r : wt,
            f = new Set(c.keys());
      l = st(d, f) ? l : { ...l,
        nodeDeps: ut(l.nodeDeps, t, f)
      };
      const p = ye(f, d),
            S = ye(d, f);

      for (const e of p) l = { ...l,
        nodeToNodeSubscriptions: it(l.nodeToNodeSubscriptions, e, e => ct(null != e ? e : wt, t))
      };

      for (const e of S) l = { ...l,
        nodeToNodeSubscriptions: it(l.nodeToNodeSubscriptions, e, e => lt(null != e ? e : wt, t))
      };
    ...
    return function (n, o, r) {
      "loading" !== r.state ? !0 == !e.dangerouslyAllowMutability && s(r.contents) : r.contents.then(r => (!0 == !e.dangerouslyAllowMutability && s(r), u = u.set(o, ht(r)), n.fireNodeSubscriptions(new Set([t]), "now"), r)).catch(r => (a(r) || (!0 == !e.dangerouslyAllowMutability && s(r), u = u.set(o, St(r)), n.fireNodeSubscriptions(new Set([t]), "now")), r)), u = u.set(o, r);
    }(o, m, b), [l, b];
  }
    ...
    return vt({
      ...
      set: function (e, t, n) {
        ...
        function s({
          ...
          throw "loading" === r.state ? new Rt(t) : r.contents;
        }

        function u(t, n) {
          const r = "function" == typeof n ? n(s(t)) : n;
          let u;
          [o, u] = pt(e, o, t.key, r), u.forEach(e => a.add(e));
        }
...
const {
  useRecoilCallback: At,
  useRecoilState: Et,
  useRecoilStateLoadable: Mt,
  useRecoilValue: Nt,
  useRecoilValueLoadable: _t,
  useResetRecoilState: Lt,
  useSetRecoilState: kt,
  useSetUnvalidatedAtomValues: Bt,
  useTransactionObservation: Ut,
  useTransactionSubscription: xt
} = Qe,
      {
  DefaultValue: Ct
} = T,
...
var It = {
  ...
  useResetRecoilState: Lt,
  useRecoilCallback: At,
  useTransactionObservation_UNSTABLE: Ut,
  useTransactionSubscription_UNSTABLE: xt,
  useSetUnvalidatedAtomValues_UNSTABLE: Bt,
  isRecoilValue: Dt
},
    jt = It.DefaultValue,
    Pt = It.RecoilRoot,
...
/* harmony import */ var recoil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! recoil */ "./node_modules/recoil/dist/recoil.js");
/* harmony import */ var recoil__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(recoil__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_dom__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index.scss */ "./src/recoil/index.scss");
...
var textState = Object(recoil__WEBPACK_IMPORTED_MODULE_2__["atom"])({
  key: 'textState',
  // unique
  "default": '' //默认值
...
function TextInput() {
  var _useRecoilState = Object(recoil__WEBPACK_IMPORTED_MODULE_2__["useRecoilState"])(textState),
      _useRecoilState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useRecoilState, 2),
      text = _useRecoilState2[0],
      setText = _useRecoilState2[1];
...
var valueLength = Object(recoil__WEBPACK_IMPORTED_MODULE_2__["selector"])({
  key: "valueLength",
  get: function get(_ref) {
    var _get = _ref.get;

    // 通过 get 可以读取其它状态
    var inputValue = _get(textState);
...
function CharCount() {
  var count = Object(recoil__WEBPACK_IMPORTED_MODULE_2__["useRecoilValue"])(valueLength);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, count);
}

function App() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TextInput, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(CharCount, null));
}

react_dom__WEBPACK_IMPORTED_MODULE_3___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(recoil__WEBPACK_IMPORTED_MODULE_2__["RecoilRoot"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(App, null)), document.getElementById('app'));

/***/ }),

/***/ "./src/recoil/index.scss":
/*!*******************************!*\
  !*** ./src/recoil/index.scss ***!
  \*******************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/postcss-loader/src??ref--5-2!./index.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js?!./src/recoil/index.scss");
...
/******/ });
//# sourceMappingURL=index.7cbbe90.js.map